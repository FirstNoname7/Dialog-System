public static class TextUtility //весь этот скрипт скопирован для того, чтобы в проекте можно было убирать пробелы где это нужно (в тулбаре, в именах нод)
{
    ...
    public static string RemoveWhitespaces(this string text) //удалить пробелы в названиях
    {
    ...
    public static string RemoveSpecialCharacters(this string text) //удалить спец. символы в названиях
    {
        int textLength = text.Length;
